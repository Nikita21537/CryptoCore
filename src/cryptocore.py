...
from src.cryptocore.cli_parser import parse_args
from src.cryptocore.file_io import (read_file_with_iv, write_file_with_iv,
                                    read_gcm_file, read_etm_file)
from src.cryptocore.modes import create_mode
from src.cryptocore.csprng import generate_aes_key, print_key_info, generate_random_bytes
from src.cryptocore.hash import create_hash
from .mac import HMACStream, parse_hmac_file
from src.cryptocore.modes.gcm import GCM, AuthenticationError as GCMAuthError
from src.cryptocore.modes.encrypt_then_mac import EncryptThenMAC, AuthenticationError as ETMAuthError
from src.cryptocore.kdf import pbkdf2_hmac_sha256, derive_key  # NEW IMPORT NEW IMPORT
